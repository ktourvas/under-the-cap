...
class Present extends Model {
    ...
    protected $fillable = [ 'date', 'draw_id', 'daily_give', 'total_give', 'total_given', 'remaining' ];

    protected $hidden = [ 'draw_id', 'daily_give', 'daily_given', 'track', 'total_give', 'total_given', 'remaining' ];
